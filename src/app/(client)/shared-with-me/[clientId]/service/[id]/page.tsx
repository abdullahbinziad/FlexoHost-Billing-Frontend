...
export default function SharedWithMeServicePage() {
  ...
  return (
    <div className="space-y-4 max-w-2xl">
      <Card>
        <CardHeader>
          <CardTitle>{service.name || service.identifier || service.id}</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-sm text-muted-foreground">
            Type: {service.productType ?? "—"} · Status: {service.status}
          </p>
        </CardContent>
      </Card>
    </div>
