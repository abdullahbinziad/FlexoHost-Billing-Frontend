...
/**
 * Edit VPS/Server Package Page
 * 
 * Allows admin users to edit existing VPS/Server packages.
...
export default function EditServerPage() {
    ...
    const handleUpdateProduct = async (updatedData: Omit<Product, "id" | "createdAt" | "isHidden">) => {
        try {
            ...
            const errorMessage = error?.data?.message || error?.message || "Failed to update VPS/Server package. Please try again.";
    ...
    if (isLoading) {
        return (
            <div className="space-y-6">
                <PageHeader
                    title="Edit VPS/Server Package"
                    description="Loading product details..."
                    breadcrumbs={[
                        { label: "Products", href: "/admin/products" },
                        { label: "VPS/Server", href: "/admin/products/server" },
                        { label: "Edit" }
                    ]}
            ...
            <div className="space-y-6">
                ...
                <div className="flex justify-center items-center h-64">
                    <div className="text-center">
                        ...
                        <button
                            onClick={() => router.push("/admin/products/server")}
