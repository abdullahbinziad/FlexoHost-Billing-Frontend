...
const CURRENCY_OPTIONS = ["BDT", "USD"];
  ...
  useEffect(() => {
    if (client) {
      ...
      setForm({
        ...
        accountCreditCurrency: client.accountCreditCurrency ?? "BDT",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await updateClient({
      ...
      data: {
        ...
        accountCreditCurrency: form.accountCreditCurrency || undefined,
        address:
          parts.length > 0
            ? {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={form.accountCreditCurrency}
                onValueChange={(value) => setForm((p) => ({ ...p, accountCreditCurrency: value }))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
              ...
              <p className="text-xs text-muted-foreground">
                New services and silent domain adoption use this currency by default.
              </p>
            </div>
          </div>
          <div className="space-y-2">
