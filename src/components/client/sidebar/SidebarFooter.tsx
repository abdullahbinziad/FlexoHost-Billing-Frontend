...
interface SidebarFooterProps {
  onLinkClick: () => void;
  isCollapsed: boolean;
  /** Hide Status and Settings links (e.g. for admin sidebar - already has Settings in nav) */
  hideStatusAndSettings?: boolean;
}

export function SidebarFooter({
  onLinkClick,
  isCollapsed,
  hideStatusAndSettings = false,
}: SidebarFooterProps) {
