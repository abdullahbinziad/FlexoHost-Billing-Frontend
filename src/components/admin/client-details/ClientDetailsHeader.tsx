import { User, MapPin, Mail, ExternalLink, RefreshCw, Shield } from "lucide-react";
    ...
    return (
        <div className="space-y-4 mb-6">
            <div className="flex flex-col lg:flex-row justify-between items-start gap-4">
                ...
                <div className="flex flex-col sm:flex-row gap-2 w-full lg:w-auto items-end">
                    ...
                    {/* Support PIN badge + Regenerate (same style as client header) */}
